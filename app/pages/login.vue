...
<template>
  <div
    ...
    <div class="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-amber-500/15 blur-[120px] rounded-full"></div>
    <div class="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-rose-700/10 blur-[120px] rounded-full"></div>
    ...
    <div class="w-full max-w-md z-10">
      ...
      <div
        ...
        <form @submit.prevent="handleLogin" class="space-y-4">
          <div class="space-y-2">
            <label for="email" class="text-sm font-medium text-stone-700 ml-1">Email Address</label>
            <div class="relative group">
              <div
                class="absolute left-3 top-1/2 -translate-y-1/2 text-stone-400 group-focus-within:text-amber-700 transition-colors">
                <Mail class="w-5 h-5" />
              </div>
              <input id="email" v-model="email" type="email" placeholder="admin@batik.com"
          ...
          <div class="space-y-2">
            <div class="flex items-center justify-between ml-1">
              ...
              <a href="#" class="text-xs text-amber-700 hover:text-amber-600 transition-colors">Forgot password?</a>
            </div>
            <div class="relative group">
              <div
                class="absolute left-3 top-1/2 -translate-y-1/2 text-stone-400 group-focus-within:text-amber-700 transition-colors">
